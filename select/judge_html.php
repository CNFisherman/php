...
<html>
 ...
 <body>
	<form action="./judgeshow.php" method="post">
		<div class="box">
		<div class="title">判断题信息列表</div>
		...
		<table border="1">
			...
			<tr>
				 ...
				 <td><?php echo $row['judge_info']; ?></td>
				 <td><?php echo $row['judge_answ']; ?></td>
				 <td><?php echo $row['judge_pic']; ?></td>
				 <td><?php echo $row['judge_level']; ?></td>
				 <td><?php echo $row['judge_chapter']; ?></td>
				 <td><?php echo $row['judge_score']; ?></td>
				 <td>
					<div align="center">
					<span>
							<a href="<?php echo '../update/judgeUpdate.php?judge_id='.$row['judge_id'] ?>">编辑</a>&nbsp; &nbsp;
							<a href="<?php echo '../delete/judge.php?judge_id='.$row['judge_id'] ?>">删除</a>
						</span>
					</div>
				</td>
			</tr>
		...
		<div class="search"><a href="/add/judge.html">添加题目</a></div>
 </body>
</html>
