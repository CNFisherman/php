...
<div class="box">
	...
	<table class="profile-table">
		<tr><th>内容：</th><td><input type="text" name="design_info" value="<?php echo $design_info['design_info']; ?>"/></td></tr>
		<tr><th>答案：</th><td><input type="text" name="design_answ" value="<?php echo $design_info['design_answ']; ?>"/></td></tr>
		<tr><th>难度：</th><td><input type="text" name="design_level" value="<?php echo $design_info['design_level']; ?>"/></td></tr>
		<tr><th>章节：</th><td><input type="text" name="design_chapter" value="<?php echo $design_info['design_chapter']; ?>"/></td></tr>
		<tr><th>分值：</th><td><input type="text" name="design_score" value="<?php echo $design_info['design_score']; ?>"/></td></tr>
