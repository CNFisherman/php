...
<div class="box">
	...
	<table class="profile-table">
		<tr><th>内容：</th><td><input type="text" name="cal_info" value="<?php echo $cal_info['cal_info']; ?>"/></td></tr>
		<tr><th>答案：</th><td><input type="text" name="cal_answ" value="<?php echo $cal_info['cal_answ']; ?>"/></td></tr>
		<tr><th>难度：</th><td><input type="text" name="cal_level" value="<?php echo $cal_info['cal_level']; ?>"/></td></tr>
		<tr><th>章节：</th><td><input type="text" name="cal_chapter" value="<?php echo $cal_info['cal_chapter']; ?>"/></td></tr>
		<tr><th>分值：</th><td><input type="text" name="cal_score" value="<?php echo $cal_info['cal_score']; ?>"/></td></tr>
