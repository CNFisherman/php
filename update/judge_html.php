...
<div class="box">
	...
	<table class="profile-table">
		<tr><th>内容：</th><td><input type="text" name="judge_info" value="<?php echo $judge_info['judge_info']; ?>"/></td></tr>
		<tr><th>答案：</th><td><input type="text" name="judge_answ" value="<?php echo $judge_info['judge_answ']; ?>"/></td></tr>
		<tr><th>难度：</th><td><input type="text" name="judge_level" value="<?php echo $judge_info['judge_level']; ?>"/></td></tr>
		<tr><th>章节：</th><td><input type="text" name="judge_chapter" value="<?php echo $judge_info['judge_chapter']; ?>"/></td></tr>
		<tr><th>分值：</th><td><input type="text" name="judge_score" value="<?php echo $judge_info['judge_score']; ?>"/></td></tr>
